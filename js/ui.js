...
export class UI {
  constructor({ renderer, input, audio, progression, sprites }){
    ...
    this.screen='splash';
    this.sel = { fighter:'shade', opponent:'granite', difficulty:'easy' };
    this.results = null;
  ...
  _cycleFighter(dir){
    const unlocks=this.progression.unlocks();
    const list = ['blaze','granite','shade','volt'];
  ...
  _renderSplash(){
    ...
    if(t < 1.4){
      ...
      c.font = '900 52px Impact, system-ui, sans-serif';
      c.fillStyle = '#fff';
      c.shadowColor = 'rgba(120,240,255,0.9)';
      c.shadowBlur = 30 + Math.sin(t * 8) * 5;
      c.fillText('PIXEL', 0, -30);

      c.font = '900 68px Impact, system-ui, sans-serif';
    ...
    if(t > 0.9 && t < 2.6){
      ...
      for(let i = 0; i < 4; i++){
        ...
        // Fighter icon
        c.textAlign = 'center';
        c.font = '600 28px Impact, system-ui, sans-serif';
    ...
    if(t > 1.5 && t < 2.8){
      ...
      c.textAlign = 'center';
      c.textBaseline = 'middle';
      c.font = '700 14px Impact, system-ui, sans-serif';
  ...
  _renderMenu(){
    ...
    for(let i = 0; i < this._menuItems.length; i++){
      ...
      if(selected){
        c.save();
        c.textAlign = 'left';
        c.font = '900 20px Impact, system-ui, sans-serif';
      ...
      c.textAlign = 'center';
      c.textBaseline = 'middle';
      c.font = `${selected ? '900' : '700'} ${selected ? 20 : 18}px Impact, system-ui, sans-serif`;
      ...
      if(i === 1){
        ...
        c.save();
        c.textAlign = 'center';
        c.font = '600 11px Impact, system-ui, sans-serif';
  ...
  _renderSelect(){
    ...
    if(this._dailyMode){
      ...
      c.textAlign='center';
      c.textBaseline='middle';
      c.font='900 14px Impact, system-ui, sans-serif';
      c.fillStyle='rgba(255,245,190,0.95)';
      c.shadowColor='rgba(255,215,64,0.7)';
      c.shadowBlur=10;
      c.fillText(`${daily.icon} DAILY: ${daily.name}`, 300, 22);
      c.shadowBlur=0;
      c.font='600 10px Impact, system-ui, sans-serif';
      c.fillStyle='rgba(255,255,255,0.75)';
    ...
    c.textAlign='center';
    c.textBaseline='top';
    c.font='900 40px Impact, system-ui, sans-serif';
    ...
    c.textAlign='center';
    c.textBaseline='top';
    c.font='650 10px Impact, system-ui, sans-serif';
  ...
  _renderResults(r){
    ...
    c.textAlign = 'center';
    c.textBaseline = 'middle';
    c.font = '900 56px Impact, system-ui, sans-serif';
    ...
    for(let i = 0; i < statLines.length; i++){
      ...
      c.textAlign = 'left';
      c.font = '700 13px Impact, system-ui, sans-serif';
  ...
  _renderHighScoreEntry(r){
    ...
    c.save();
    c.textAlign = 'center';
    c.font = '900 26px Impact, system-ui, sans-serif';
    ...
    for(let i = 0; i < 3; i++){
      ...
      c.textAlign = 'center';
      c.textBaseline = 'middle';
      c.font = '900 34px Impact, system-ui, sans-serif';
      ...
      if(selected){
        c.save();
        c.textAlign = 'center';
        c.font = '600 16px Impact, system-ui, sans-serif';
    ...
    for(let i = 0; i < scores.length; i++){
      ...
      c.textAlign = 'left';
      c.font = `${isNew?'800':'700'} 11px Impact, system-ui, sans-serif`;
